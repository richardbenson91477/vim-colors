...
let colors_name = "idm2-256"

hi Normal           ctermfg=254     ctermbg=none    cterm=none
hi Keyword          ctermfg=212                     cterm=none
hi Statement        ctermfg=229                     cterm=none
hi Constant         ctermfg=217                     cterm=none
hi Number           ctermfg=158                     cterm=none
hi PreProc          ctermfg=117                     cterm=none
hi Function         ctermfg=183                     cterm=none
hi Identifier       ctermfg=146                     cterm=none
hi Type             ctermfg=219                     cterm=none
